...
class $AssetsLottiesGen {
  ...
  /// File path: assets/lotties/documents.json
  LottieGenImage get documents =>
      const LottieGenImage('assets/lotties/documents.json');
  ...
  LottieGenImage get typing =>
      const LottieGenImage('assets/lotties/typing.json');

  /// List of all assets
  List<LottieGenImage> get values => [documents, loading, splash, typing];
}
